  ...
  return (
    <div className="py-10">
      ...
      <div className="text-center">
        <h3 className="text-3xl font-medium py-10">Explore trending topics</h3>
        <div className="flex flex-wrap justify-center gap-3 w-1/2 mx-auto">
          {topics.map((item, index) => (
            <button
              key={index}
              onClick={() => handleTopicClick(item.name)}
              className={`w-fit border-2 border-black p-3 rounded-full space-x-2 hover:bg-black hover:text-white duration-300 ${
